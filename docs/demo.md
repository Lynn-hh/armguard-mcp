...
>>> get_robot_state({})
{
  ...
  "wrench": {"frame_id": "fr3_link0", "force": {"x": 0.0, "y": 0.0, "z": 0.0}, "torque": {"x": 0.0, "y": 0.0, "z": 0.0}, "stamp": 1790136092.8743},
  "safety": {"estopped": false, "reason": null, "estopped_at": null, "dry_run": false, "force_violation_latched": false, "last_violation": null, "executing_plan_id": null, "note": "Software envelope only (defense in depth). The robot's own safety system and hardware e-stop remain the real safety layer."}
}
...
>>> execute_plan({"plan_id": "23a2f7dc142d"})
{
  "plan_id": "23a2f7dc142d",
  "status": "completed",
...
(progress notifications received: 9, last=1.00)

# Plan handles are single-use:

>>> execute_plan({"plan_id": "23a2f7dc142d"})
ERROR: Error executing tool execute_plan: plan 23a2f7dc142d cannot be used: already used (plan handles are single-use). Plan again.
...
>>> execute_plan({"plan_id": "ece04bc62c23"})

--- approval prompt shown to the human (MCP elicitation) ---
APPROVE ROBOT MOTION on 'fr3'? Plan ece04bc62c23 (joints: joints -> [-0.851, -0.4666, 0.1682, -2.3493, 0.0793, 1.8874, 0.9601]).
...
>>> execute_plan({"plan_id": "3707467d7932"})
ERROR: Error executing tool execute_plan: refused: plan 3707467d7932 violates hard safety limits and can never be executed: sample 96: TCP (0.634, 0.356, 0.319) m enters keep-out zone 'camera_mount'
...
>>> estop({"reason": "demo: operator saw something odd"})
{
  ...
  "estopped_at": "2026-09-23T04:01:33.309Z",
  "dry_run": false,
...
{"seq": 4, "event": "tool_call", "tool": "execute_plan", "outcome": "ok", "plan_id": "23a2f7dc142d", "approval": {"decision": "not_required", "via": "policy"}}
{"seq": 5, "event": "tool_call", "tool": "execute_plan", "outcome": "denied", "plan_id": "23a2f7dc142d"}
{"seq": 6, "event": "tool_call", "tool": "get_robot_state", "outcome": "ok"}
{"seq": 7, "event": "tool_call", "tool": "plan_to_joints", "outcome": "ok", "plan_id": "ece04bc62c23"}
{"seq": 8, "event": "tool_call", "tool": "execute_plan", "outcome": "ok", "plan_id": "ece04bc62c23", "approval": {"decision": "approved", "via": "human", "operator": "lynn", "required": true}}
{"seq": 9, "event": "tool_call", "tool": "plan_to_pose", "outcome": "ok", "plan_id": "3707467d7932"}
{"seq": 10, "event": "tool_call", "tool": "execute_plan", "outcome": "denied", "plan_id": "3707467d7932"}
